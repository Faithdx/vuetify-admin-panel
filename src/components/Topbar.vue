    ...
    <v-menu offset-y>
        ...
        <span style="cursor: pointer" v-bind="attrs" v-on="on">
          <v-chip link>
            <v-badge dot bottom color="green" offset-y="10" offset-x="10">
              <v-avatar size="40">
                <v-img src="../assets/images/avatars/girl.png" />
              </v-avatar>
            </v-badge>
            <span class="ml-3">Dylan He</span>
          </v-chip>
        </span>
      </template>
      <v-list width="250" class="py-0">
        <v-list-item two-line>
          <v-list-item-avatar>
            <img src="../assets/images/avatars/girl.png" />
          </v-list-item-avatar>

          <v-list-item-content>
            <v-list-item-title>Dylan He</v-list-item-title>
